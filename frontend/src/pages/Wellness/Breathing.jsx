        ...
        <Col lg={7}>
          <Card className="feature-card p-4">
            ...
            <div className="text-center my-4">
              <div
                ...
                style={{
                  ...
                  margin: '0 auto',
                  borderRadius: '50%',
                  background: isRunning ? 'var(--color-primary-500)' : 'var(--color-primary-50)',
            ...
            <div className="d-flex gap-2 mt-3">
              <Button variant="primary" onClick={startBreathing} disabled={isRunning || completed}>
                {isRunning ? 'Running...' : 'Start'}
              </Button>
              <Button variant="warning" onClick={() => { setIsRunning(false); setPhase('idle'); }} disabled={!isRunning}>
                Pause
              </Button>
              <Button
                variant="secondary"
