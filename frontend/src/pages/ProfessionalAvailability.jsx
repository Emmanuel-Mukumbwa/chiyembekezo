...
const ProfessionalAvailability = () => {
  ...
  const fetchAvailability = async () => {
    ...
    try {
      ...
      const res = await api.get(`/availability/professional/${user.id}`); // or use a separate endpoint
  ...
  const addSlot = async (e) => {
    ...
    try {
      ...
      await api.put('/availability/professional', { slots });
  ...
  const deleteSlot = async (id) => {
    ...
    try {
      await api.delete(`/availability/professional/${id}`);
      fetchAvailability();
    } catch (err) {
