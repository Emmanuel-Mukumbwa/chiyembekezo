            ...
            <Nav className="ms-auto align-items-lg-center">
              {user ? (
                ...
                <>
                  ...
                  <Nav.Link as={NavLink} to="/about" onClick={handleNavClick} className="nav-link">
                    About
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/resources" onClick={handleNavClick} className="nav-link">
                    Resources
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/assessments" onClick={handleNavClick} className="nav-link">
                    Assessments
                  </Nav.Link>
